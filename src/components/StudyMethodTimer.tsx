...
export default function StudyMethodTimer({ session }: Props) {
...
const styles = StyleSheet.create({
  ...
  phaseLabel: { fontSize: 13, color: COLORS.textMuted, marginTop: 6, fontWeight: '600' },
  countdown: { fontSize: 28, fontWeight: '700', color: COLORS.text, marginTop: 4, letterSpacing: 1 },
  totalRemaining: { fontSize: 11, color: COLORS.textMuted, marginTop: 4, fontWeight: '600' },
  doneText: { fontSize: 13, fontWeight: '600', color: COLORS.text, marginTop: 6, textAlign: 'center' },
});
